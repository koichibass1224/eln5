...
if (isset($_FILES["upfile"] ) && $_FILES["upfile"]["error"] ==0 ) {
    ...
    if ( is_uploaded_file( $tmp_path ) ) {
        if ( move_uploaded_file( $tmp_path, $file_dir_path ) ) {
            ...
            //３．データ登録SQL作成
            $stmt = $pdo->prepare("INSERT INTO image_table (id,ad1,ad2,ad3,ad4,contributor) VALUES(NULL,:ad1,:ad2,:ad3,:ad4,:contributor)");
            ...
            $stmt->bindValue(':contributor', $u_name, PDO::PARAM_STR);
            $status = $stmt->execute();
            ...
            if($status==false){
              ...
              header("Location: textupload_profile.php");
            }
        } else {
